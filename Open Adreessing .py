...
for i in range(n):
    h2.put(i,i);
for i in range(n):
    if(type(h2.get(i))!= int): print(i,"ERROR");
print("Open Adreessing Linear probing HashTable OK");

for i in range(n):
    h3.put(i,i);
for i in range(n):
    if(type(h3.get(i))!= int): print(i,"ERROR");
print("Open Adreessing Quardratic probing HashTable OK");

for i in range(n):
    h4.put(i,i);
for i in range(n):
    if(type(h4.get(i))!= int): print(i,"ERROR");
